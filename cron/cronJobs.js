...
cron.schedule('40 10 * * 1-7', async ()=> {
    console.log('Running scheduled job at 10:40 am (Mon-Sun) at Singapore timezone...');
    try {
...
console.log('Cron job scheduled for 10:40  am (Mon-Sun).');